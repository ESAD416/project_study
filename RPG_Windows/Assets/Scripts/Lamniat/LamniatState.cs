...
public class LamniatState : MonoBehaviour
{
    [SerializeField] private Lamniat m_targetLamniat;
    public Lamniat TargetLamniat => this.m_targetLamniat;
    ...
    public void SetCurrentBaseState(LamniatStateMachine state) {
        ...
        this.m_currentBaseState.OnEnter(m_targetLamniat);
    }
    ...
    {
        m_idle = new IdleState_Lamniat(m_targetLamniat);
        m_move = new MoveState_Lamniat(m_targetLamniat);
        m_attack = new AttackState_Lamniat(m_targetLamniat);
        m_jump = new JumpState_Lamniat(m_targetLamniat);
        m_dodge = new DodgeState_Lamniat(m_targetLamniat);
        m_hurt = new HurtState_Lamniat(m_targetLamniat);
        m_dead = new DeadState_Lamniat(m_targetLamniat);
